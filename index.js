        ...
        for (const channel of channels[0]) {
            ...
            if (channelObj) {
                try {
                    ...
                    try {
                        channel.send('I\'ve been configured to delete messages in this channel, but I\'m missing permissions. Can you double check that I have Manage Messages permissions in this channel? This message will repeat every time I try to delete messages here, assuming I have permissions to send messages in this channel.');
                    } catch (e) {
                        console.error(`Also can't send messages in this channel. Eventually, I should send something to the guild owner.`);
                    }
                }
            }
        }
